    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="mb-8 bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    <div class="bg-white border border-gray-200 rounded-2xl p-6 transition-all duration-300 hover:shadow-lg" style="border-color: #e5e7eb;" onmouseover="this.style.borderColor='#012d48';" onmouseout="this.style.borderColor='#e5e7eb';">
