...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">إضافة شهادة جديدة</h1>

        <form action="{{ route('employee.educations.store', ['locale' => app()->getLocale()]) }}" method="POST" class="bg-white border border-gray-200 rounded-lg p-6">
            @csrf
            ...
            <div class="mb-6" id="end_date_container">
