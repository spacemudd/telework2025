            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="relative">
                    <input type="radio" 
                           ...
                           required>
                    <label for="company" 
                           class="flex items-center w-full h-full min-h-[120px] p-6 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer hover:text-gray-600 hover:bg-gray-50 peer-checked:border-blue-600 peer-checked:text-blue-600 peer-checked:bg-blue-50">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="text-sm text-left rtl:text-left ltr:text-right mt-1">{{ __('auth.i_want_hire_remote_workers') }}</div>
                        </div>
                    </label>
                </div>
                ...
                <div class="relative">
                    ...
                    <label for="job_seeker" 
                        ...
                        <div class="flex-1">
                            ...
                            <div class="text-sm text-left rtl:text-left ltr:text-right mt-1">{{ __('auth.i_want_find_remote_work') }}</div>
                        </div>
                    </label>
                </div>
            </div>
