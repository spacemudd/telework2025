    ...
    <div class="grid grid-cols-12 p-5 gap-5">
        <div class="col-span-12">
            <div class="grid grid-cols-2 md:grid-cols-6 gap-4">
                <a href="{{ route('admin.settings.company-defaults') }}" class="block p-4 bg-white rounded shadow hover:shadow-md transition">
                ...
                <a href="{{ route('admin.settings.attendance-sheet') }}" class="block p-4 bg-white rounded shadow hover:shadow-md transition">
                ...
                <a href="{{ route('admin.settings.ticketing-system') }}" class="block p-4 bg-white rounded shadow hover:shadow-md transition">
                ...
                <a href="{{ route('admin.settings.alerts') }}" class="block p-4 bg-white rounded shadow hover:shadow-md transition">
                ...
                <a href="{{ route('admin.settings.telework-integration') }}" class="block p-4 bg-white rounded shadow hover:shadow-md transition">
