                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                    ...
                    <div class="flex flex-col justify-center relative">
                        ...
                        <div class="relative z-20">
                            <h2 class="text-4xl md:text-6xl font-bold text-gray-800 mb-6 xs:text-center sm:text-start">
                            ...
                            <li class="flex items-center justify-center lg:justify-start {{ app()->getLocale() === 'ar' ? 'lg:flex-row lg:text-left' : 'lg:flex-row-reverse lg:text-right' }} text-center">
                                <svg class="h-5 w-5 text-green-500 flex-shrink-0 {{ app()->getLocale() === 'ar' ? 'mr-4' : 'ml-4' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
